 ...
 * @author Diego
 */
public class ShowInfoReserve extends javax.swing.JPanel {
    User sessionUser;
    ReserveControl reserveControl;
    /**
     * Creates new form ShowInfoReserve
     */
    public ShowInfoReserve(User sessionUser) {
        initComponents();
    ...
    private void backButtomActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backButtomActionPerformed
        ...
        ListReservation listReservation = new ListReservation(sessionUser);
