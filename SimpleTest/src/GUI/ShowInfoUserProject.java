 ...
 * @author Diego
 */
public class ShowInfoUserProject extends javax.swing.JPanel {
    User sessionUser;
    UserControl userControl;
    String projectID;
    /**
     * Creates new form ShowInfoUserProject
     */
    public ShowInfoUserProject(User sessionUser,String projectID) {
        initComponents();
    ...
    private void backButtomActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backButtomActionPerformed
        ...
        ListProjectMember listProjectMember = new ListProjectMember(sessionUser, projectID);
        listProjectMember.setSize(639,483);
    ...
    public void setValues(String code, String identification, String firstName, String lastName, String email, String phone){
        
       User user;
       user = userControl.getUserInfo(identification);
       ...
       typeIDLabel.setText(user.getTypeID());
       firstNameLabel.setText(firstName);
       lastNameLabel.setText(lastName);
       emailLabel.setText(email);
       chargeLabel.setText(user.getCharge());
